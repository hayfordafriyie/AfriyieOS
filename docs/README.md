...
| [architecture/ipc-protocol.md](architecture/ipc-protocol.md) | 🔨 endpoints and the four primitives implemented, v0.6 | Endpoints, message format, `send`/`recv`/`call`/`reply`, grants |
